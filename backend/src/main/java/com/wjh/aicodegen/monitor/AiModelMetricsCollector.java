...
public class AiModelMetricsCollector {
    ...
    // 记录各种模型的调用次数
    private final ConcurrentMap<String, Counter> modelCountersCache = new ConcurrentHashMap<>();
     ...
     * @param modelName
     */
    public void recordModelCallCount(String userId, String appId, String modelName) {
        String key = String.format("%s_%s_%s", userId, appId, modelName);
        Counter counter = modelCountersCache.computeIfAbsent(key, k ->
                Counter.builder("ai_model_calls_total")
