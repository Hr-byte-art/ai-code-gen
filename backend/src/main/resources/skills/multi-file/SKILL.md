...
6. 代码质量: 代码必须结构清晰，有必要的意图注释。
7. 输出格式: 只能输出 3 个完整代码块，顺序固定为 `html`、`css`、`javascript`。不要输出标题、解释、总结或代码块之外的任何文本。
8. 每个代码块必须一次性闭合，禁止输出半截代码。
...
2. 确保始终最多输出 1 个 HTML 代码块 + 1 个 CSS 代码块 + 1 个 JavaScript 代码块，里面包含完整页面代码，而不是片段代码。
