...
public class CodeGenWorkflow {
    ...
    private String routeAfterQualityCheck(MessagesState<String> state) {
        ...
        int qualityCheckCount = context.getQualityCheckCount();
        // 如果质检失败，重新生成代码
        ...
        // 质检通过，使用原有的构建路由逻辑
        if (qualityCheckCount > 5) {
            log.info("代码质检操过最大循环次数");
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "代码生成失败，请重新生成代码");
        }
